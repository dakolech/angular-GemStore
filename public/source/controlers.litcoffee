...
#app.controller 'StoreController', ['$scope', 'ProductService', '$routeParams', ($scope, ProductService, $routeParams) ->
#app.controller 'StoreController', ($scope, ProductService, $http) ->
